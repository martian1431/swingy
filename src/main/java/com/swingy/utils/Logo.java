...
//TODO: Refactor
public class Logo {
    private static final String instructions = "ANSI_YELLOW + \":::\" + ANSI_RESET + CYAN_BOLD_BRIGHT + \"HERE ARE THE RULES\" + ANSI_RESET + ANSI_YELLOW + \":::\\n\" + ANSI_RESET +\n" +
    ...
    private static String  logo() {
        ...
        "\t\t\t\t\t\t" + CYAN_UNDERLINED + "Copyright " + COPYRIGHT + " 2020  Made with " + HEART + " by pmalope\n" + ANSI_RESET;
    }
